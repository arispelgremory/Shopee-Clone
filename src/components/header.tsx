        ...
        <div className="custom-container">
          <div className="w-full flex justify-between h-[2.125rem]">
            ...
            <div className="flex header-right">
              ...
              <div className="text-[13px] leading-[1.2] text-light-color items-center flex [&>a]:px-[10px] font-medium">
                <a href="">Sign Up</a>
                <a href="">Login</a>
              </div>
            </div>
          </div>
          <nav className="h-[85px] flex items-center header-with-search">
            <div className="logo">
              <svg
                viewBox="0 0 192 65"
                className="w-[162px] h-[50px] fill-white"
              >
                <g fillRule="evenodd">
            ...
            <div className="search-bar-wrapper w-[840px]">
              ...
              <div className="recommendations">
                <div className="overflow-clip w-full flex flex-wrap mt-[0.1875rem] h-[1.5rem] text-[.75rem] leading-[1.5rem]">
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=kasut%20sukan"
                  >
                    Kasut Sukan
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=topup%20maxis%20pin"
                  >
                    Topup Maxis Pin
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=baju%20raya%20sulam%202024"
                  >
                    Baju Raya Sulam 2024
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=casing%20iphone%2011"
                  >
                    Casing iPhone 11
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=baju%20rm1"
                  >
                    Baju Rm1
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=robux%20gift%20card%20murah"
                  >
                    Robux Gift Card Murah
                  </a>
                  <a
                    aria-hidden="false"
                    className="_5AQ6Sz"
                    href="/search?keyword=handbag%20aesthetic%20korean%20style"
                  >
                    Handbag Aesthetic Korean Style
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=t%20shirt%20ootd"
                  >
                    T Shirt OOTD
                  </a>
                  <a
                  ...
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=mancing%20casting%201%20set%20murah"
                  >
                    Mancing Casting 1 Set Murah
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=kamera%20mini%20keluar%20gambar"
                  >
                    Kamera Mini Keluar Gambar
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=earphone%20bluetooth"
                  >
                    Earphone Bluetooth
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=akun%20ff%20murah%20sultan%20malaysia"
                  >
                    Akun FF Murah Sultan Malaysia
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=tudung%20raqtive%20murah"
                  >
                    Tudung Raqtive Murah
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=topup%20digi%20free"
                  >
                    Topup Digi Free
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=seluar%20perempuan"
                  >
                    Seluar Perempuan
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=iphone%2014%20pro%20max"
                  >
                    iPhone 14 Pro Max
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=selipar%20la"
                  >
                    Selipar La
                  </a>
                  <a
                  ...
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=blouse%20women%20murah%20rm10"
                  >
                    Blouse Women Murah RM10
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=glad2glow"
                  >
                    Glad2glow
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=topup%20free%20tanpa%20bayaran"
                  >
                    Topup Free Tanpa Bayaran
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=baju%20set%20perempuan%20korean%20style"
                  >
                    Baju Set Perempuan Korean Style
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=heels%20murah"
                  >
                    Heels Murah
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=bootcut%20sukan%20perempuan"
                  >
                    Bootcut Sukan Perempuan
                  </a>
                  <a
                    aria-hidden="true"
                    tabIndex="-1"
                  ...
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=bawal%20printed"
                  >
                    Bawal Printed
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=pencil%20box"
                  >
                    Pencil Box
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=barang%20baby"
                  >
                    Barang Baby
                  </a>
                  <a
                    ...
                    tabIndex="-1"
                    className="_5AQ6Sz"
                    href="/search?keyword=jam%20tangan%20lelaki"
                  >
                    Jam Tangan Lelaki
                  </a>
                </div>
            ...
            <div className="cart-wrapper">
              <div className="cart-drawer-container">
                <img src="/images/cart.svg" alt="cart" className='w-[26px] h-[26px] cursor-pointer' />
              </div>
            </div>
          </nav>
        </div>
